...
public class FTPUtil {
    ...
    private static  final  String FTPIP=PropertiesUtil.readByKey("ftp.server.ip");
    private static  final  String FTPUSER=PropertiesUtil.readByKey("ftp.server.user");
    private static  final  String FTPPASSWORD=PropertiesUtil.readByKey("ftp.server.password");
